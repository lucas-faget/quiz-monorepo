...
const playerItemVariants = cva("flex items-center justify-between p-3 rounded-lg transition-all duration-200", {
    variants: {
        rank: {
...
const rankBadgeVariants = cva("flex items-center justify-center size-8 text-sm font-bold", {
    variants: {
        rank: {
...
function getRankVariant(rank: number, isCurrentPlayer: boolean): "default" | "first" | "second" | "third" | "current" {
...
export function Leaderboard({
    ...
    return (
        <Card data-slot="leaderboard" className={className} font={"retro"} {...props}>
            {title && (
                <CardHeader>
